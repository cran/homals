...
plot(res, plot.type = "vecplot", var.subset = 2, main = "Vector Plot Rater 2", xlim = c(-0.08, 0.12))
plot(res, plot.type = "prjplot", var.subset = 2, main = "Projection Plot Rater 2", xlim = c(-0.08, 0.12))
@
